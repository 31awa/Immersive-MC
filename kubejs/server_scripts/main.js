...
ServerEvents.recipes(event => {
  event.recipes.create.pressing('kubejs:40mm', 'kubejs:steel_plate')
})
ServerEvents.recipes(event => {
  event.recipes.create.cutting('kubejs:casing', '#forge:plates/brass').processingTime(250)
}) 
ServerEvents.recipes(event => {
  event.recipes.create.cutting('kubejs:12g', 'minecraft:paper').processingTime(250)
})
...
ServerEvents.recipes(event => {
	...
	], 'kubejs:casing', [ // 'create:golden_sheet' is the input
